...
<body>
    ...
    <div class="container pt-3" style="margin-top:90px">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-md-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">เพิ่มห้องพัก</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="card mt-3">
            <div class="card-body">
                <form method="post" action="room_add_db.php" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="room_name" class="form-label">ชื่อห้อง</label>
                        <input type="text" class="form-control" name="room_name" id="room_name" maxlength="50">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="daily_price" id="daily_price" min="0" step="1" value="0">
                    </div>
                    <div class="mb-3">
                        <label for="monthly_price" class="form-label">ราคารายเดือน</label>
                        <input type="text" class="form-control" name="monthly_price" id="monthly_price" min="0" step="1" value="0">
                    </div>
                    <div class="mb-3">
                        <label for="beds" class="form-label">จำนวนเตียง</label>
                        <input type="number" class="form-control" name="beds" id="beds" min="1" step="1" value="1">
                    </div>
                    <div class="mb-3">
