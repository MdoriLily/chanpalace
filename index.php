        ...
        <div class="container">
            <div class="row d-flex align-items-center h-100vh">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="text-white">CHANPALACE HOTEL</h1>
                    <h3 class="text-white">NAKHON PATHOM</h3>
                    <a href="room.php" class="btn btn-primary btn-lg mt-3">ดูห้องพัก</a>
                </div>
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_SESSION['login_user'])) {
                                ...
                                <div class="d-grid gap-2">
                                    <span class="mb-2 text-center">คุณกำลังมองหาห้องพักใช่ไหม?</span>
                                    <a href="prebooking.php" class="btn btn-primary btn-lg">จองห้องพักกับเรา</a>
                                </div>
                                <?php
                            }
                            else {
                                ?>
                                <div class="d-grid gap-2">
                                    <a href="login.php" class="btn btn-primary btn-lg"><i class="fa-solid fa-arrow-right-to-bracket me-3"></i>เข้าสู่ระบบ</a>
                                    <span class="mt-2 text-center">ถ้าหากคุณยังไม่มีชื่อผู้ใช้งาน</span>
